"""Test script: Frame 150 with NO SWAP AT ALL."""
...
def main():
    ...
    print(f"Frame 150 MPJPE after NO SWAPS AT ALL: {errs.mean():.1f} mm")
    ...
    plot_skel(pred3d, 'red', 'Triangulated (NO SWAP)')
    
    ax.legend()
    ax.set_xlim(-200, -100); ax.set_ylim(-50, 50); ax.set_zlim(0, 200)
    out = ROOT / "no_swap_viz.png"
